...
Project-specific agent instructions live in `docs/ai/repo-rules.md`; read that file before making code, architecture, standards, or Truthmark-routing changes in this repository.

Keep this file's Truthmark-managed block intact. If `truthmark init` rewrites the managed block, preserve this repository-rules pointer outside the managed block.
